                    ...
                    withCredentials([
                        ...
                        sh(
                            script: """
                                ...
                                ssh -o StrictHostKeyChecking=no -o ConnectTimeout=10 -i "\$SSH_KEY" "\$SSH_USER"@${ip} "test -f ${path}/.env.production && test -f ${path}/.env.mysql" || {
                ...
                script {
                    ...
                    withCredentials([
                        ...
                        sh(
                            script: """
                                chmod 600 "\$SSH_KEY" 2>/dev/null || true
                                ssh -o StrictHostKeyChecking=no -o ConnectTimeout=10 -i "\$SSH_KEY" "\$SSH_USER"@${ip} '${remoteCmd}'
                            """,
